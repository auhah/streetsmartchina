...
sources:
  - label: "Beijing Municipal Government payment services"
    url: "https://english.beijing.gov.cn/specials/paymentservices/"
  - label: "Alipay+ official guide to paying in the Chinese mainland"
    url: "https://alipayplus.com/pay-in-the-chinese-mainland"
  - label: "DotDotNews report on the 2025-12-19 PBOC/NDRC/NAFR cash rules"
    url: "https://english.dotdotnews.com/"
  - label: "Mothership report on the 2025-12 PBOC/NDRC/NAFR cash rules"
...
faq:
  ...
  - q: "How much cash should I bring?"
    a: "Bring a small cash fallback rather than making cash your main payment plan."
  - q: "Can tourists get a Chinese bank account?"
    a: "You do not need one for this setup. Mobile payments can now bind foreign cards."
---
...
In 2024-03, China's mobile payment access for foreign visitors changed so international cards could be bound directly in mobile wallets. The practical result for travelers is simple: you no longer need a Chinese bank account to use the main mobile-payment setup described here.

A 2025-12-19 joint PBOC/NDRC/NAFR announcement set a cash rule effective from 2026-02-01: offline merchants must accept cash, refusing cash is illegal, and enforcement is tighter. That does not make cash the easiest daily payment method, but it does make cash a serious fallback.
...
These fee numbers were verified on 2026-07-04 from the listed sources.

| Payment route | Verified fees and limits | Practical use |
| --- | --- | --- |
| Alipay | No service fee at <=¥200; 3% service fee above ¥200; card issuer foreign-exchange fee may add 1-3%. | Primary setup for most travelers. |
| WeChat Pay | No service fee at <=¥200; 3% service fee above ¥200; card issuer foreign-exchange fee may add 1-3%. | Backup wallet alongside Alipay. |
| Direct foreign card | Card issuer foreign-exchange fee may add 1-3%; POS acceptance is rare outside airports and high-end hotels. | Backup only. |
| Cash | Offline merchants must accept cash from 2026-02-01 under the rules cited above. | Fallback when app or card payment fails. |
